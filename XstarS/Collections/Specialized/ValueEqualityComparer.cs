...
namespace XstarS.Collections.Specialized
{
    ...
    public sealed class ValueEqualityComparer<T> : EqualityComparer<T>
    {
        ...
        /// <summary>
        /// 返回一个默认的 <see cref="ValueEqualityComparer{T}"/> 实例。
        /// </summary>
        ...
        public override bool Equals(T x, T y) => new ValueEquatablePair(x, y).ValueEquals();
        ...
        public override int GetHashCode(T obj) => new ValueHashCodeObject(obj).GetValueHashCode();
    }
}
