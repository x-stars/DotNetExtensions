...
namespace XstarS
{
    partial class Validate
    {
        ...
        /// <paramref name="source"/> 的值不为一个空集合。</exception>
        public static IValidate<IEnumerable<T>> IsEmpty<T>(this IValidate<IEnumerable<T>> source,
            string message = null)
        {
            if (source.Value.Any())
            {
        ...
        /// <returns><paramref name="source"/> 本身。</returns>
        /// <exception cref="ArgumentException">
        /// <paramref name="source"/> 的值为一个空集合。</exception>
        ...
        /// <param name="message">自定义抛出异常的消息。</param>
        /// <returns><paramref name="source"/> 本身。</returns>
        /// <exception cref="ArgumentException"><paramref name="source"/> 的值的元素数量不在
        ...
        /// <returns><paramref name="source"/> 本身。</returns>
        /// <exception cref="ArgumentException">
        /// <paramref name="source"/> 的值包含 <see langword="null"/>。</exception>
