...
namespace XstarS.Collections
{
    ...
    /// </summary>
    [Serializable]
    internal sealed class DictionaryEntryRepresenter : ObjectRepresenterBase<DictionaryEntry>
    {
        /// <summary>
        ...
        {
            var keyRepresenter = ObjectRepresenter.OfType(value.Key?.GetType());
            var valueRepresenter = ObjectRepresenter.OfType(value.Value?.GetType());
