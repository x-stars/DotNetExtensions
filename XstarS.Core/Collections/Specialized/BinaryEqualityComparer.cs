...
namespace XstarS.Collections.Specialized
{
    ...
    public sealed class BinaryEqualityComparer<T> : EqualityComparer<T> where T : unmanaged
    {
        ...
        public override bool Equals(T x, T y) => UnmanagedTypeHelper.BinaryEquals(x, y);
        ...
        public override int GetHashCode(T obj) => UnmanagedTypeHelper.GetBinaryHashCode(obj);
    }
}
