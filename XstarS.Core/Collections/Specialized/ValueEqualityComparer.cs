...
namespace XstarS.Collections.Specialized
{
    ...
    public sealed class ValueEqualityComparer<T> : SimpleEqualityComparer<T>
    {
        ...
        public override bool Equals([AllowNull] T x, [AllowNull] T y) => ObjectValues.RecursiveEquals(x, y);
        ...
        public override int GetHashCode([AllowNull] T obj) => ObjectValues.GetRecursiveHashCode(obj);
    }
}
