...
namespace XstarS.Collections.Specialized
{
    ...
    public sealed class ArrayBinaryEqualityComparer<T> : EqualityComparer<T[]> where T : unmanaged
    {
        ...
        public override bool Equals(T[] x, T[] y) => UnmanagedValueHelper.BinaryEquals(x, y);
        ...
        public override int GetHashCode(T[] obj) => UnmanagedValueHelper.GetBinaryHashCode(obj);
    }
}
