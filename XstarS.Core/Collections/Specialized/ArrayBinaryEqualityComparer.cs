...
namespace XstarS.Collections.Specialized
{
    ...
    [Serializable]
    public sealed class ArrayBinaryEqualityComparer<T> : EqualityComparer<T[]> where T : unmanaged
    {
        /// <summary>
        ...
        public override bool Equals(T[] x, T[] y) => UnmanagedTypeArrayHelper.BinaryEquals(x, y);
        ...
        public override int GetHashCode(T[] obj) => UnmanagedTypeArrayHelper.GetBinaryHashCode(obj);
    }
}
