...
{
    /// <summary>
    /// 可析构对象，支持将对象作为空值元组 <see cref="ValueTuple"/> 析构。
    /// </summary>
    public interface IDeconstructable
    {
        /// <summary>
        /// 将当前对象作为空值元组 <see cref="ValueTuple"/> 析构。
        /// </summary>
        void Deconstruct();
    }

    /// <summary>
    /// 可析构对象，支持将对象作为 1 元值元组 <see cref="ValueTuple{T1}"/> 析构。
    /// </summary>
    public interface IDeconstructable<T1>
    {
        /// <summary>
        /// 将当前对象作为 1 元值元组 <see cref="ValueTuple{T1}"/> 析构。
        /// </summary>
    ...
    /// <summary>
    /// 可析构对象，支持将对象作为 2 元值元组 <see cref="ValueTuple{T1, T2}"/> 析构。
    /// </summary>
    public interface IDeconstructable<T1, T2>
    {
        /// <summary>
        /// 将当前对象作为 2 元值元组 <see cref="ValueTuple{T1, T2}"/> 析构。
        /// </summary>
        /// <param name="item1">值元组的第 1 个元素。</param>
    ...
    /// <summary>
    /// 可析构对象，支持将对象作为 3 元值元组 <see cref="ValueTuple{T1, T2, T3}"/> 析构。
    /// </summary>
    public interface IDeconstructable<T1, T2, T3>
    {
        /// <summary>
        /// 将当前对象作为 3 元值元组 <see cref="ValueTuple{T1, T2, T3}"/> 析构。
        /// </summary>
        /// <param name="item1">值元组的第 1 个元素。</param>
        /// <param name="item2">值元组的第 2 个元素。</param>
    ...
    /// <summary>
    /// 可析构对象，支持将对象作为 4 元值元组 <see cref="ValueTuple{T1, T2, T3, T4}"/> 析构。
    /// </summary>
    public interface IDeconstructable<T1, T2, T3, T4>
    {
        /// <summary>
        /// 将当前对象作为 4 元值元组 <see cref="ValueTuple{T1, T2, T3, T4}"/> 析构。
        /// </summary>
        /// <param name="item1">值元组的第 1 个元素。</param>
        /// <param name="item2">值元组的第 2 个元素。</param>
        /// <param name="item3">值元组的第 3 个元素。</param>
    ...
    /// <summary>
    /// 可析构对象，支持将对象作为 5 元值元组 <see cref="ValueTuple{T1, T2, T3, T4, T5}"/> 析构。
    /// </summary>
    public interface IDeconstructable<T1, T2, T3, T4, T5>
    {
        /// <summary>
        /// 将当前对象作为 5 元值元组 <see cref="ValueTuple{T1, T2, T3, T4, T5}"/> 析构。
        /// </summary>
        /// <param name="item1">值元组的第 1 个元素。</param>
        /// <param name="item2">值元组的第 2 个元素。</param>
        /// <param name="item3">值元组的第 3 个元素。</param>
    ...
    /// <summary>
    /// 可析构对象，支持将对象作为 6 元值元组 <see cref="ValueTuple{T1, T2, T3, T4, T5, T6}"/> 析构。
    /// </summary>
    public interface IDeconstructable<T1, T2, T3, T4, T5, T6>
    {
        /// <summary>
        /// 将当前对象作为 6 元值元组 <see cref="ValueTuple{T1, T2, T3, T4, T5, T6}"/> 析构。
        /// </summary>
        /// <param name="item1">值元组的第 1 个元素。</param>
        /// <param name="item2">值元组的第 2 个元素。</param>
        /// <param name="item3">值元组的第 3 个元素。</param>
    ...
    /// <summary>
    /// 可析构对象，支持将对象作为 7 元值元组 <see cref="ValueTuple{T1, T2, T3, T4, T5, T6, T7}"/> 析构。
    /// </summary>
    public interface IDeconstructable<T1, T2, T3, T4, T5, T6, T7>
    {
        /// <summary>
        /// 将当前对象作为 7 元值元组 <see cref="ValueTuple{T1, T2, T3, T4, T5, T6, T7}"/> 析构。
        /// </summary>
        /// <param name="item1">值元组的第 1 个元素。</param>
        /// <param name="item2">值元组的第 2 个元素。</param>
        /// <param name="item3">值元组的第 3 个元素。</param>
    ...
    /// <summary>
    /// 可析构对象，支持将对象作为 n 元值元组 <see cref="ValueTuple{T1, T2, T3, T4, T5, T6, T7, TRest}"/> 析构。
    /// </summary>
    public interface IDeconstructable<T1, T2, T3, T4, T5, T6, T7, TRest> where TRest : struct
    {
        /// <summary>
        /// 将当前对象作为 n 元值元组 <see cref="ValueTuple{T1, T2, T3, T4, T5, T6, T7, TRest}"/> 析构。
        /// </summary>
        /// <param name="item1">值元组的第 1 个元素。</param>
        /// <param name="item2">值元组的第 2 个元素。</param>
        /// <param name="item3">值元组的第 3 个元素。</param>
