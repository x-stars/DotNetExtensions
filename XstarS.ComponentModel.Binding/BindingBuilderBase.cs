...
namespace XstarS.ComponentModel
{
    ...
    public abstract class BindingBuilderBase<T> : IBindingBuilder<T> where T : class
    {
        /// <summary>
        /// <see cref="BindingBuilderBase{T}.BindableType"/> 的延迟初始化对象。
        /// </summary>
        private readonly Lazy<Type> LazyBindableType;

        /// <summary>
        /// 初始化 <see cref="BindingBuilderBase{T}"/> 类的新实例。
        /// </summary>
        protected BindingBuilderBase() : this(false) { }
        ...
        protected BindingBuilderBase(bool bindableOnly)
        {
