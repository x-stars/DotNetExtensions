...
namespace XstarS.Reflection
{
    ...
    internal static class SimplePropertyAccessor<TObject>
    {
        ...
        public static T? GetValue<T>(TObject @object, string propertyName)
        {
            ...
            return ((Func<TObject, T?>)getValueDelegate).Invoke(@object);
        }
        ...
        public static void SetValue<T>(TObject @object, string propertyName, T? value)
        {
            ...
            ((Action<TObject, T?>)setValueDelegate).Invoke(@object, value);
        }
