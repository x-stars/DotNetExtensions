...
namespace XNetEx.Runtime.CompilerServices
{
    ...
    public static unsafe class UnmanagedTypeArray
    {
        ...
        /// <summary>
        /// 确定当前非托管类型的二维数组与指定非托管类型的二维数组的值是否二进制相等。
        /// </summary>
        /// <typeparam name="T">非托管类型的数组中的元素的类型。</typeparam>
        /// <param name="array">要进行二进制相等比较的非托管类型的二维数组。</param>
        ...
        /// <summary>
        /// 确定当前非托管类型的三维数组与指定非托管类型的三维数组的值是否二进制相等。
        /// </summary>
        /// <typeparam name="T">非托管类型的数组中的元素的类型。</typeparam>
        /// <param name="array">要进行二进制相等比较的非托管类型的三维数组。</param>
